{{-- @include('instructor.dashboard.courses.sections.partials.modal') --}}

@extends('adminlte::page')

@section('title', 'Capacítate RD - Create Section')
...
@section('content_header')
    ...
    <h1 class="color-primary">{{ Lang::get('Add Section') }}</h1>
@stop

@section('content')

    <div class="card mb-5">
        {!! Form::open(['route' => 'instructor.dashboard.courses.sections.store']) !!}
