<a href="{{ route('instructor.courses.create' ) }}" class="col-span-1">    
...
<a href="{{ route('instructor.courses.microsoft.create' ) }}" class="col-span-1">    
    <figure class="relative cursor-pointer">
        <div class="h-40 w-5/6 mx-auto rounded-lg overflow-hidden">
...
<a href="{{ route('instructor.courses.linkedin.create' ) }}" class="col-span-1">    
    <figure class="relative cursor-pointer">
        <div class="h-40 w-5/6 mx-auto rounded-lg overflow-hidden">
