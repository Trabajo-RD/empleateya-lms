<section>
    <h2 class="font-bold text-2xl mb-12 text-gray-600">Valoraciones</h2>
        ...
        <article>
            ...
            @can('valued', $course)
                ...
                <div class="text-center">
                    ...
                    <!-- rating -->
                        <p class="text-xl mt-6">¿Cómo valorarías este curso?</p>
                    ...
                    <button class="btn btn-primary mt-2 mb-8" wire:click="store">Dejar reseña</button>
