    ...
    <div class="bg-gray-200 py-4 mb-16 z-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
            ...
            <div class="relative mr-4" x-data="{ open: false }">
                ...
                <!-- dropdown body -->
                <div class="absolute left-0 w-40 mt-2 py-2 bg-white rounded shadow" x-show="open" x-on:click.away="open = false">
            ...
            <div class="relative mr-4" x-data="{ open: false }">
                <button class="block bg-white shadow h-12 px-4 rounded text-gray-700 overflow-hidden focus:outline-none" x-on:click="open = true">
                    <i class="fas fa-photo-video text-2xl md:text-sm md:mr-2"></i><span class="hidden md:inline">{{ __('Type') }}<i class="fas fa-caret-down text-sm ml-2"></i></span>
                </button>
                <!-- dropdown body -->
                <div class="absolute left-0 w-60 mt-2 py-2 bg-white rounded shadow" x-show="open" x-on:click.away="open = false">
            ...
            <div class="relative mr-4" x-data="{ open: false }">
                <button class="block bg-white shadow h-12 px-4 rounded text-gray-700 overflow-hidden focus:outline-none" x-on:click="open = true">
                    <i class="fas fa-layer-group text-2xl md:text-sm md:mr-2"></i><span class="hidden md:inline">{{ __('Level') }}<i class="fas fa-caret-down text-sm ml-2"></i></span>
                </button>
                <!-- dropdown body -->
                <div class="absolute left-0 w-40 mt-2 py-2 bg-white rounded shadow" x-show="open" x-on:click.away="open = false">
            ...
            <div class="relative mr-4" x-data="{ open: false }">
                <button class="block bg-white shadow h-12 px-4 rounded text-gray-700 overflow-hidden focus:outline-none" x-on:click="open = true">
                    <i class="fas fa-laptop-house text-2xl md:text-sm md:mr-2"></i><span class="hidden md:inline">{{ __('Modality') }}<i class="fas fa-caret-down text-sm ml-2"></i></span>
                </button>
                <!-- dropdown body -->
                <div class="absolute left-0 w-60 mt-2 py-2 bg-white rounded shadow" x-show="open" x-on:click.away="open = false">
