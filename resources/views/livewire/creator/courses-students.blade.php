                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @foreach ( $students as $student )
                        ...
                        <!-- TODO: First <td> responsive -->
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-md text-gray-500 text-center">{{ ($student->last_login != null) ? $student->last_login : 'Nunca' }}</div>
                            </td>

                            <td class="text-right text-sm font-medium flex items-center pt-8">

                                {{-- TODO: Crear boton para notificar estudiante --}}
                                <button type="button" wire:click="reminder('{{ $student->email }}')" title="Enviar recordatorio" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
                                    <i class="far fa-bell text-gray-600"></i>
                                </button>

                                <span class="hidden sm:block">
                                    <a href="" class="px-4 py-2 ml-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
