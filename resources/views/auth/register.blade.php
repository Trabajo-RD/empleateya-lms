<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex flex-wrap items-center mt-4 justify-between md:space-x-4">
                ...
                <div class="w-full md:w-1/2 flex-1 mt-4 md:mt-0">
            ...
            <div class="flex flex-wrap items-center md:mt-4 md:justify-between md:space-x-4">
            ...
            <div class="flex flex-wrap items-center md:mt-4 justify-between md:space-x-4">
                <div class="w-full md:w-1/2 mt-4 md:mt-0">
            ...
            <div class="flex flex-wrap items-center justify-end mt-6">
                ...
                <span class="w-full md:w-max text-center md:text-right">
                    @if (Route::has('login'))
                        <span class="text-sm text-gray-600 mr-1">{{ __('Already registered?') }}</span>
                        <a class="underline text-sm text-blue-500 hover:text-blue-900" href="{{ route('login') }}">
                            {{ __('Sign In') }}
                        </a>
                    @endif
                </span>

                <x-jet-button class="mt-4 md:mt-0 md:ml-4 bg-blue-600 hover:bg-blue-700">
                    {{ __('Register') }}
                </x-jet-button>
            </div>
        </form>
