            ...
            <div class="container py-8 grid grid-cols-5 gap-6">
                ...
                <aside class="col-span-5 md:col-span-1 mb-8">
                    ...
                    <ul class="text-md text-gray-600 mt-6">
                        <!-- menu item -->
                        <li class="leading-7 mb-1 py-2 border-l-4 @routeIs('instructor.courses.edit', [app()->getLocale(), $course]) border-blue-900 text-blue-900 bg-white bg-opacity-80 filter hover:drop-shadow-lg @else border-transparent bg-white hover:bg-white bg-opacity-40 hover:bg-opacity-50 filter hover:drop-shadow-lg @endif pl-2">
                            <i class="fas fa-info-circle mr-2"></i>
                            <a href="{{ route('instructor.courses.edit', [app()->getLocale(), $course] )}}" class="@routeIs('instructor.courses.edit', [app()->getLocale(), $course]) text-blue-900 font-bold @endif">{{ __('Course information') }}</a>
                        </li>
                        <!-- menu item -->
                        <li class="leading-7 mb-1 py-2 border-l-4 @routeIs('instructor.courses.curriculum', [app()->getLocale(), $course]) border-blue-900 text-blue-900 bg-white bg-opacity-80 filter hover:drop-shadow-lg @else border-transparent bg-white hover:bg-white bg-opacity-40 hover:bg-opacity-50 filter hover:drop-shadow-lg @endif pl-2">
