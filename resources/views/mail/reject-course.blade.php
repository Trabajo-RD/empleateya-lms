			...
			<td align="center" width="600" bgcolor="#FFFFFF">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tbody>
                        ...
                        <!-- H1 -->
                        <tr>
                            <td class="h1" align="left" bgcolor="#FFFFFF" style="padding-top: 50px; padding-right: 50px; padding-bottom: 0px; padding-left: 50px; font-size: 22px; line-height:43px; color: #1F2937;" >
                                <h1>Capacítate RD</h1>
                            </td>
                        </tr>
                        ...
                        <!-- H2 -->
                        <tr>
                            <td class="h2" align="left" bgcolor="#FFFFFF" style="padding-top: 0px; padding-right: 50px; padding-bottom: 30px; padding-left: 50px; font-size: 16px; line-height:27px; font-weight: 400; color: #EE2A24;">
                                <h2>Notificación de Curso Rechazado.</h2>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="left" bgcolor="#FFFFFF" style="padding-top: 0px; padding-right: 50px; padding-bottom: 0px; padding-left: 50px; font-size: 16px; line-height:24px; font-weight: 400; color: #919191;">
                                ...
                                <p>
                                    Le notificamos que se ha rechazado el curso <strong>{{ $course }}</strong> por las siguientes razones:
                                </p>
                            </td>
                        </tr>
                        ...
                        <!-- FEATURED CONTENT -->
                        <tr>
                            <td align="left" bgcolor="#FFFFFF" style="padding-top: 0px; padding-right: 50px; padding-bottom: 10px; padding-left: 50px; font-size: 16px; line-height:24px; font-weight: 400; color: #EE2A24;">
                                <p>
                                    {!! $observation !!}.
                                </p>
                            </td>
                        ...
                        <tr>
                            <td align="left" bgcolor="#FFFFFF" style="padding-top: 0px; padding-right: 50px; padding-bottom: 50px; padding-left: 50px; font-size: 16px; line-height:24px; font-weight: 400; color: #919191;">
                                <p>
                                    Si desea obtener más información, favor escribir a <a href="mailto:capacitate@mt.gob.do" target="_blank">capacitate@mt.gob.do</a>, y con gusto le atenderemos lo más pronto posible.
                                </p>
                            </td>
                        </tr>
