...
@section('content_header')
    <a href="{{ route( 'admin.prices.create', app()->getLocale() ) }}" class="btn btn-primary float-right"><i class="fas fa-plus mr-1"></i>Nuevo precio</a>
    <h1 class="text-primary">Precios</h1>
@stop
                ...
                <tbody>
                    @foreach( $prices as $price )
                        <tr>
                            ...
                            <td>{{ $price->name }}</td>
                            <td width="12%">
                                <a href="{{ route('admin.prices.edit', [app()->getLocale(), $price] ) }}" class="btn btn-outline-secondary"><i class="far fa-edit mr-1"></i>Editar</a>
                            </td>
                            <td width="14%">
                                <form action="{{ route( 'admin.prices.destroy', [app()->getLocale(), $price] ) }}" method="POST" class="delete-price">
                                    @csrf
                                    @method('delete')
