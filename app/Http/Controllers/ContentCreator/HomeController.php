    ...
    public function index(){
        ...
        Event::listen(BuildingMenu::class, function(BuildingMenu $event){
            ...
            $event->menu->add([
                ...
                'text'  => 'content_creator_dashboard',
                'url' => route('content-creator.dashboard.index', app()->getLocale()),
            ...
            $event->menu->addAfter('content_creator_dashboard', [
                'key'           => 'content_creator_courses',
                'text'          => 'content_creator_courses',
