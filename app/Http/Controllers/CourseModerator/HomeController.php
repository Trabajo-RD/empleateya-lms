...
namespace App\Http\Controllers\CourseModerator;
...
class HomeController extends Controller
{
    public function index(){
        ...
        /**
         * Event AdminLTE BuildingMenu for Course Moderators
         */
        Event::listen(BuildingMenu::class, function(BuildingMenu $event){
            ...
            // Dashboard Home
            $event->menu->add([
                'key'   => 'course_moderator_dashboard',
                'text'  => 'course_moderator_dashboard',
                'url' => route('course-moderator.dashboard.index', app()->getLocale()),
        ...
        return view('course-moderator.index');
