...
class HomeController extends Controller
{
    public function index(){
        ...
        /**
         * Event AdminLTE BuildingMenu for Students
         */
        Event::listen(BuildingMenu::class, function(BuildingMenu $event){
            ...
            // Dashboard Home
            $event->menu->add([
                'key'   => 'content_moderator_dashboard',
                'text'  => 'content_moderator_dashboard',
                'url' => route('content-moderator.dashboard.index', app()->getLocale()),
        ...
        return view('content-moderator.index');
