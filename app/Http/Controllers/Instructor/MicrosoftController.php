...
class MicrosoftController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('can:LMS Actualizar cursos')->only('edit', 'update');
    ...
    public function create()
    {
        ...
        return view('instructor.courses.microsoft.create', compact('categories', 'types', 'levels', 'prices', 'modalities' ));
    }
    ...
    //     return redirect()->route('instructor.courses.microsoft.edit', [$locale, $course]);
    // }
    ...
    // {
    //     return view('instructor.courses.microsoft.show', compact('course'));
    // }
    ...
    //     return view('instructor.courses.microsoft.edit', compact('course', 'categories', 'types', 'levels', 'prices', 'modalities'));
    // }
