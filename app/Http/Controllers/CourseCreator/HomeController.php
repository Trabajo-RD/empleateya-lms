...
namespace App\Http\Controllers\CourseCreator;
...
class HomeController extends Controller
{
    public function index(){
        ...
        Event::listen(BuildingMenu::class, function(BuildingMenu $event){
            ...
            // Dashboard Home
            $event->menu->add([
                'key'   => 'course_creator_dashboard',
                'text'  => 'course_creator_dashboard',
                'url' => route('course-creator.dashboard.index', app()->getLocale()),
            ...
            $event->menu->addAfter('course_creator_dashboard', [
                'key'           => 'course_creator_courses',
                'text'          => 'course_creator_courses',
                // 'url'           => route('admin.courses.index' ), // url/route
                'icon'          => 'fas fa-laptop mr-1',
                'can'           => 'create-course',
                'submenu'       => [
                    [
                        'key'   => 'course_creator_all_courses',
                        'text'  => 'course_creator_all_courses',
        ...
        return view('course-creator.index');
